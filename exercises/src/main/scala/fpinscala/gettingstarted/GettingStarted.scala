...
object MyModule {
  ...
  def fib(n: Int): Int = {
    @annotation.tailrec
    def fib_help(i: Int, a: Int, b: Int): Int = {
      if (i == n) a
      else fib_help(i + 1, b, a + b)
    }
    fib_help(0, 0, 1)
  }
...
object PolymorphicFunctions {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(isSorted(Array(1, 2, 1), (a: Int, b: Int) => a >= b) == false)
    println(isSorted(Array(3, 2, 1), (a: Int, b: Int) => a >= b) == false)
  }
}
